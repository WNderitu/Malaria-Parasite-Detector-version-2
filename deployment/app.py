...
with st.expander("📸 Need test images? View & download example blood smears", expanded=False):
    ...
    SAMPLE_IMAGES = [
        {
            "label": "Sample 1",
            "filepath": os.path.join(base_path, "deployment","sample_images", "sample_1.jpg"),
            "description": "Blood smear – contains infected RBCs",
            "filename": "sample_blood_smear_1.jpg",
        },
        {
            "label": "Sample 2",
            "filepath": os.path.join(base_path,"deployment","sample_images", "sample_2.jpg"),
            "description": "Blood smear – multiple parasite stages visible",
            "filename": "sample_blood_smear_2.jpg",
        },
        {    "label": "Sample 3",
            "filepath": os.path.join(base_path, "deployment", "sample_images", "sample_3.jpg"),
